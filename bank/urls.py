...
from user.views import MyTokenObtainPairView,MailItemUpdateStatus,MailItemAllListView,BatchStatisticsAPIView,CheckMailItemAPIView,MailItemStatsAPIView,ReceivedDateMonthCountView,DeliveredMailItemListView
