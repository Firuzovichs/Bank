...
from user.views import FaceRecognitionAPIView,MyTokenObtainPairView,MailItemUpdateStatus,MailItemAllListView,BatchStatisticsAPIView,CheckMailItemAPIView,MailItemStatsAPIView,ReceivedDateMonthCountView,DeliveredMailItemListView
